      ...
      <ContentWrapper>
        <RowBetween>
          <TYPE.body>
            ...
            <Link lineHeight={'145.23%'} href={getCurrentNetworkLinks().SCAN_LINK + account} target="_blank">
              {' '}
              {account?.slice(0, 42)}{' '}
            </Link>
          </TYPE.body>
        ...
        <Header>
          <RowBetween>
            <span>
              ...
              <Link lineHeight={'145.23%'} href={getCurrentNetworkLinks().SCAN_LINK + account} target="_blank">
                <TYPE.main fontSize={14}>{getCurrentNetworkLinks().SCAN_LINK_TITLE}</TYPE.main>
              </Link>
            </span>
            <AccountWrapper>
              <StyledIcon>
            ...
            <Panel style={{ height: '100%', marginBottom: '1rem' }}>
              <AutoRow gap="20px">
                ...
                <AutoColumn gap="10px">
                  ...
                  <RowFixed align="flex-end">
                    <TYPE.header fontSize={'24px'} lineHeight={1} color={aggregateFees && '#009CE1'}>
